...
dat_files = {
	...
	"7x7x1": "etot_k7_latticeparam.dat",
	"8x8x1": "etot_k8_latticeparam.dat",
	"9x9x1": "etot_k9_latticeparam.dat",
	"10x10x1": "etot_k10_latticeparam.dat"
...
plt.savefig("convergence_latticeparam_k", dpi=300)
plt.show()
